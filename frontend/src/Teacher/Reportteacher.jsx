            ...
            <div style={{ width: "100%", height: "100vh", background: "#5840ba", display: "flex", flexDirection: "column", paddingBottom: "20px" }}>
                ...
                <div id="containerutama" className="container d-flex justify-content-center align-items-center" style={{ overflow: "scroll", flexGrow: "1", width: "100%", background: "white", marginTop: "20px", borderRadius: "20px", display: "flex" }}>
                    <div id="containerdalam" style={{ width: "96%", height: "90px", background: "" }}>
                        ...
                        <div className="d-flex justify-content-center align-items-center" style={{ width: "100%", height: "max-content", marginLeft: "20px", background: "", marginTop: "20px" }}>
                            <div className="d-flex justify-content-center shadow" style={{ width: "300px", height: "100px", background: "white", borderRadius: "12px", borderLeft: "5px solid #4e73df" }}>
                                <div className="row no-gutters align-items-center">
                                    ...
                                    <div className="col-auto">
                                        <svg xmlns="http://www.w3.org/2000/svg" style={{ color: "gray" }} width="30" height="30" fill="currentColor" className="bi bi-currency-dollar" viewBox="0 0 16 16">
                            ...
                            <div className="d-flex justify-content-center shadow" style={{ marginLeft: "20px", width: "300px", height: "100px", background: "white", borderRadius: "12px", borderLeft: "5px solid #1cc88a" }}>
                                <div className="row no-gutters align-items-center">
                                    <div className="col mr-2">
                                        <div className="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            Total Earnings</div>
                            ...
                            <div className="d-flex justify-content-center shadow" style={{ marginLeft: "20px", width: "300px", height: "100px", background: "white", borderRadius: "12px", borderLeft: "5px solid #f6c23e" }}>
                                <div className="row no-gutters align-items-center">
                                    <div className="col mr-2">
                                        <div className="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            Total Student</div>
                        ...
                        <div className="d-flex justify-content-center align-items-center" style={{ width: "100%", height: "max-content", flexDirection: "column", paddingBottom: "20px" }}>
                            <p className="text-left color-black text-dark" style={{ fontSize: "30px", marginLeft: "20px" }} align='center'><b>10 Transaksi Terakhir</b></p>
