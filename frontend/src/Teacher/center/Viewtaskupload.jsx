                                ...
                                <tbody>
                                    {
                                        dataload.map((data, counter) => {
                                            return (
                                                <tr>
                                                    <td>{counter + 1}</td>
                                                    <td><a href={"http://localhost:3000/"+data.path}>{data.namauser}</a></td>
                                                    <td>
                                                        {
                                                            data.nilai == -1 && (
                                                                <>
                                                                    <form onSubmit={handleSubmit(submitnilai)}>
                                                                        <input type="text" hidden value={data.id} {...register("idsubmit")}></input>
                                                                        <input type="number" required {...register("nilai")}></input>
