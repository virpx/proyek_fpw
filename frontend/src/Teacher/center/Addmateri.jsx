                            ...
                            {dataload[0] == "add" && (
                                <>
                                    <TextField
                                        ...
                                        {...register("nama")}
                                    />
                                    <p style={{ fontSize: "20px", marginTop: "15px", color: "black" }}>PDF</p>
                                    <input type="file" className="form-control" style={{ display: "inline", width: "100%", marginTop: "-10px" }} {...register("filepdf")}></input>
                                </>
                            )}
                            {dataload[0] == "edit" && (
                                <>
