...
export default function Coursecenter() {
    ...
    async function removemateri(idmateri) {
        var hasil = await axios.get(urlapi + "removemateri/" + dataload[1]._id.toString() + "/" + idmateri, {
            headers: {
    ...
    async function removetask(idtask){
        var hasil = await axios.get(urlapi + "removetask/" + dataload[1]._id.toString() + "/" + idtask, {
            headers: {
                "x-auth-token": (JSON.parse(localStorage.getItem("user"))).token
            }
        })
                                        ...
                                        return (
                                            <tr>
                                                ...
                                                <td>
                                                    {dataload[0] == 1 && (
                                                        <>
                                                            <a style={{ cursor: "pointer" }} className="link-primary link-opacity-100" onClick={() => {
                                                                navigate("edittopic/" + data._id.toString())
                                                            }}>Edit</a>
                                                            <a style={{ cursor: "pointer", marginLeft: "5px" }} className="link-danger link-opacity-100" onClick={() => {
